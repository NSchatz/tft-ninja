...
const getSummoner = asyncHandler(async (req, res) => {
  ...
  // const jimmy = await api.Match.listWithDetails(puuid, 'americas',{count:5})
  // tftData(jimmy)
  res.status(200).json({puuid: puuid , matches: [await api.Match.listWithDetails(puuid, 'americas',{count:5})]})
